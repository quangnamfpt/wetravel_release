...
function AdminSuppliersRestaurant({ languageSelected }) {
                    ...
                    <tbody>
                        {[...services].map((service, index) => (
                            <tr>
                                ...
                                <td>{typeService[2][parseInt(service.typeOfServiceCategory)].title}</td>
...
export default memo(AdminSuppliersRestaurant)