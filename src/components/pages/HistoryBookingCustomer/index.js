...
import { API_CREATE_FEEDBACK, API_CREATE_REQUEST_CANCEL, API_UPDATE_STATUS_BOOKING } from '../../API'
                                ...
                                {listBookingShow.map((item, index) => (
                                    <div key={index} className='mb-20 item-list-history-booking d-flex'>
                                        <div>
                                            ...
                                            <div className='mt-10'>
                                                {(item.isFeedback && <div className='price-payed-history-booking'>{languageList.txtPaid} {formatter.format(item.price)} <button className='btn-feedback-history-booking color-have-feedback'>{languageList.txtFeedbacked}</button></div>) ||
